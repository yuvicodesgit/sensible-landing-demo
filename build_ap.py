...
new_css = r"""
    ...
    :root {
      ...
      --warm-alt: #F8F6F1;          /* --_brand---bg-alt */
      --warm-alt-border: #E8E3DB;
    ...
    /* ---------- STATS RIBBON: exact values from sensible.so (.d12-ribbon / .d12-proof) ---------- */
    .d12-ribbon { background-color: #f8f6f1; border-top: 1px solid #e8e3db; }
    .d12-proof { display: grid; grid-template-columns: repeat(4, 1fr); }
    .d12-proof-cell { display: flex; flex-direction: column; align-items: center; text-align: center; row-gap: 3px; padding: 19px 22px 17px; border-left: 1px solid #e8e3db; }
    .d12-proof-cell:first-child { border-left: none; }
    .d12-proof-v { color: #1a1520; margin: 0; font-family: 'IBM Plex Serif', serif; font-size: 1.375rem; font-weight: 400; line-height: 1.05; }
    .d12-proof-l { color: #8b857b; letter-spacing: .12em; text-transform: uppercase; margin: 0; font-family: 'IBM Plex Mono', monospace; font-size: .625rem; }
    @media (max-width: 767px) {
      .d12-proof { grid-template-columns: 1fr 1fr; }
      .d12-proof-cell:nth-child(2n+1) { border-left: none; }
      .d12-proof-cell:nth-child(n+3) { border-top: 1px solid #e8e3db; }
    }
    ...
    /* lighter section rhythm: white / #F8F6F1, hairline dividers, no tinted gradients */
    .sec.stone, .sec.white { border-top: 1px solid var(--border-stone); border-bottom: none; }
    .managed { background-image: none; background: #fff; }
    .pipe-scope { background: rgba(255,255,255,.7); border-color: rgba(132,0,85,.3); }
...
{nav_html}
  ...
  <!-- STATS RIBBON (same component as sensible.so homepage) -->
  <div class="d12-ribbon">
    <div class="container">
      <div class="d12-proof">
        <div class="d12-proof-cell"><p class="d12-proof-v">75M+</p><p class="d12-proof-l">documents processed</p></div>
        <div class="d12-proof-cell"><p class="d12-proof-v">150+</p><p class="d12-proof-l">library configurations</p></div>
        <div class="d12-proof-cell"><p class="d12-proof-v">SOC 2 + HIPAA</p><p class="d12-proof-l">independently audited</p></div>
        <div class="d12-proof-cell"><p class="d12-proof-v">No credit card</p><p class="d12-proof-l">14-day free trial</p></div>
      </div>
    </div>
  </div>
